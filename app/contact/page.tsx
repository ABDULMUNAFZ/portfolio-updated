        ...
        <Form {...form}>
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Button
                type="submit"
                className="group !mb-[2em] h-auto w-auto rounded-full px-[2em] py-[1em] text-[#1c1c1c]"
                style={{ background: '#fcf2ff' }}
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group !mb-[2em] flex h-auto items-center gap-2 rounded-full px-[1.5em] py-[0.8em] text-[0.8em] font-semibold transition-all duration-300 hover:scale-105"
                style={{
                  background: 'rgba(246,142,212,0.1)',
                  border: '1px solid rgba(246,142,212,0.3)',
                  color: '#f68ed4',
