...
export const metadata: Metadata = {
  title: "Abdul Munaf Z • Front-End Developer",
  description:
    "Abdul Munaf Z is a Front-End Developer skilled in React.js, TypeScript, Python, and Machine Learning. Building scalable, user-focused web solutions.",
};
