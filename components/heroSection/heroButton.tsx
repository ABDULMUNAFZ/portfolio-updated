...
export function HeroButton({}) {
  ...
  return (
    <Magentic
      strength={50}
      className="email_section1 anime isolate z-20  rounded-full !text-[clamp(16px,_1vw_+_14px,_24px)] md:bg-[#2a2a2a]"
      ...
      <div className="shapka !flex items-center justify-center gap-[3.5rem]">
        <div className="round hidden items-center justify-center md:flex">
          <p className="absolute left-[37%] whitespace-nowrap text-[21px]">
            <span>
              <span className="scrambleText">Explore</span>
              <br />
              <span className="scrambleText">My Work</span>
            </span>
          </p>
        </div>
