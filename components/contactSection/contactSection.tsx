...
export function ContactSection({}) {
  const { suscribe } = useAppSelector((state) => state.fullpageReducer.sixth);
  const bgImagesSharedRef = useRef<gsap.core.Tween | null>(null);

  return (
    <section className="section section__6 sixth darkGradient relative flex items-center justify-center overflow-hidden px-paddingX py-paddingY">
      <Bulge type="Light" />
      ...
      <BgImagesContainer bgImagesSharedRef={bgImagesSharedRef} suscribe={suscribe} />
      <Footer />
    </section>
  );
}
